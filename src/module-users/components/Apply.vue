  ...
  <div class="usersContainer">
    ...
    >
      ...
      <el-form-item label="期望离职时间" :class="computeOpType?'item-enable':'item-dismiss'">
        <el-date-picker v-model="ruleForm.expectedDepartureTime" type="date" format="yyyy-MM-dd"
      ...
      <el-form-item label="加班开始时间" :class="computeOpType?'item-dismiss':'item-enable'">
        <el-date-picker v-model="ruleForm.overtimeStartTime" type="datetime" format="yyyy-MM-dd HH:mm:ss"
                        placeholder="选择日期时间"></el-date-picker>
      </el-form-item>
      <el-form-item label="加班结束时间" :class="computeOpType?'item-dismiss':'item-enable'">
        <el-date-picker v-model="ruleForm.overtimeTime" type="datetime" format="yyyy-MM-dd HH:mm:ss"
                        placeholder="选择日期时间"></el-date-picker>
      </el-form-item>
...
<script>
  import {applyDimission, applyOvertime} from '@/api/hrm/approvalsApi'
