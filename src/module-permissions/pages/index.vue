<template>
  <div class="dashboard-container">
      ...
      <el-card shadow="never">
        ...
        <el-table :data="dataList" fit style="width: 100%;" highlight-current-row>
          ...
          <el-table-column fixed="right" label="操作">
            <template slot-scope="scope">
              <el-button v-if="scope.row.type==1" @click="handleCreate(null,2);setPid(2,scope.row.id)" type="text"
                         size="small">添加权限点
              </el-button>
    ...
    <el-dialog title="API权限列表" :visible.sync="apiDialogVisible" style="hight:400px;line-height:1px">
      <el-button class="filter-item fr" size="small" style="margin-left: 10px;"
                 @click="handleCreate(null,1);setPid(3,pid)" type="primary" icon="el-icon-edit">添加api权限
      </el-button>
...
<script>
  import {detail, list, remove, saveOrUpdate} from '@/api/base/permissions'
