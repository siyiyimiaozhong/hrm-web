<template>
  <div class="add-form">
    <el-dialog title="编辑员工" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :model="formBase" label-position="left" label-width="120px"
        ...
        <el-form-item label="入职时间：">
          <el-date-picker v-model="formBase.timeOfEntry" type="date" placeholder="选择日期"
        ...
        <el-form-item label="部门：">
          <el-input placeholder="请选择" v-model="formBase.departmentName" icon="caret-bottom" class="inputW"
