          ...
          <div class="boxMain">
            <div class="mainInfo">
              ...
              <el-form-item class="formInfo" label="调整司龄(天)：">
                <el-input type="number" v-model="formData.adjustmentAgedays" placeholder="请输入"
              ...
              <el-form-item class="formInfo" label="调整工龄(天)：">
                <el-input type="number" v-model="formData.adjustmentOfLengthOfService" placeholder="0"
                          class="inputW"></el-input>
              </el-form-item>
              ...
              <el-form-item class="formInfo" label="直属下属数量：">
                <el-input type="number" v-model="formData.numberOfSubordinateSubordinates" placeholder="1"
                          class="inputW" disabled></el-input>
              </el-form-item>
            </div>
            <div class="mainInfo">
            ...
            <div class="mainInfo">
              ...
              <el-form-item class="formInfo" label="推荐企业/人：">
                <el-input v-model="formData.recommenderBusinessPeople" placeholder="请输入"
                          class="infoPosition inputW"></el-input>
              </el-form-item>
            </div>
            <div slot="footer" class="dialog-footer">
              <el-button type="primary" @click="saveData('formData')">保存更新</el-button>
              <router-link :to="{'path':'/employees/index'}" class="el-button el-button--default el-button--medium">返回
              </router-link>
            </div>
          </div>
        </el-form>
...
<script>
  ...
  import {jobsDetail, postDetail} from '@/api/base/employees'
