            ...
            <div class="headText">
              <el-form ref="formData" :model="userData" label-width="215px" label-position="right">
                ...
                <el-row>
                  ...
                  <el-col :span="12">
                    <div>
                      ...
                      <el-input placeholder="请选择" v-model="userData.departmentName" icon="caret-bottom" class="inputW"
                ...
                <el-row :span="42">
                  ...
                  <router-link :to="{'path':'/employees/index'}" class="el-button el-button--default el-button--medium">
                    返回
                  </router-link>
          ...
          <el-form ref="formData" :model="formData" label-width="215px" label-position="right">
            ...
            <div class="mainInfo tabInfo" ref="tabInfo2">
              ...
              <el-form-item class="formInfo" label="联系手机：">
                <el-input v-model="formData.contactTheMobilePhone" placeholder="11位字符" maxlength="11"
            ...
            <div class="mainInfo tabInfo" ref="tabInfo5">
              ...
              <el-form-item class="formInfo" label="有无竞业限制：">
                <el-input type="textarea" v-model="formData.isThereAnyCompetitionRestriction" placeholder="请输入"
...
<script>
  ...
  import {personal, personalDetail} from '@/api/base/employees'
