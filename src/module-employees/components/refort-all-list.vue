<template>
  <div class="boxInfo">
    ...
    <div class="tags-container tagInfo">
      <el-tag v-for="item in seleList" :key="item" :disable-transitions="false" closable @close="seleClose(item)"
              class="active">
        {{item}}
      </el-tag>
    </div>
...
<script>
  import {checkPhone} from '@/filters/index'
  import {importDown, refort} from '@/api/base/employees'
