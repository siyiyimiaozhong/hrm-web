      ...
      <el-card>
        ...
        <div class="fr">
          <router-link :to="{'path':'/employees/import/',query: {name: '员工'}}"
                       class="el-button el-button--primary el-button--mini" title="导入">导入
          </router-link>
          <el-button type="primary" size="mini" title="设置">设置</el-button>
          <router-link :to="{'path':'/employees/archiving/'}" class="el-button el-button--primary el-button--mini"
                       title="历史归档">历史归档
          </router-link>
          <router-link :to="{'path':'/employees/report/1'}" class="el-button el-button--primary el-button--mini">1月份报表
          </router-link>
        ...
        <el-table :data="dataList" fit style="width: 100%;" border>
          ...
          <el-table-column fixed="right" label="操作" align="center" width="260">
            <template slot-scope="scope">
              ...
              <router-link :to="{'path':'/employees/adjustPost/' + scope.row.id}"
                           class="el-button el-button--text el-button--small">
                调岗
              </router-link>
              <router-link :to="{'path':'/employees/leave/' + scope.row.id}"
                           class="el-button el-button--text el-button--small">
                离职
              </router-link>
