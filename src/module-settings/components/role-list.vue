      ...
      <div>
        ...
        <div class="userInfo">
          ...
          <div class="pagination">
            <PageTool :paginationPage="requestParameters.page" :paginationPagesize="requestParameters.pagesize"
...
<script>
  import {add, assignPerm, detail, list, remove, update} from '@/api/base/role'
