<template>
  <div class="login-container">
    <el-form class="login-form" autoComplete="on" :model="loginForm" :rules="loginRules" ref="loginForm"
      ...
      <el-button class="loginBtn" type="primary" style="width:49%;margin-bottom:30px;" :loading="loading"
                 @click.native.prevent="handleLogin">{{$t('login.logIn')}}
      </el-button>
      <el-button class="loginBtn" type="primary" style="width:49%;margin-bottom:30px; margin-left:0"
                 @click="handlecode">刷脸登录
      </el-button>
      <div class="regInfo">
...
<script>
  ...
  import {codeCheck, qrcode} from '@/api/base/faceLogin'
