    ...
    <div>
      <el-form :model="ruleForm" label-width="110px" class="demo-ruleForm">
        <el-form-item label="调整基本工资">
          ...
          <el-input
            v-model="ruleForm.adjustmentOfBasicWages"
            style="width: 220px;"
        ...
        <el-form-item label="调整岗位工资">
          ...
          <span class="Label">-></span>
          <el-input
            v-model="ruleForm.adjustPostWages"
            style="width: 220px;"
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      computeChangeTotal() {
        let base = 0;
        if (this.ruleForm.adjustmentOfBasicWages != null) {
          base = Number(this.ruleForm.adjustmentOfBasicWages);
        }
        let post = 0;
        if (this.ruleForm.adjustPostWages != null) {
          post = Number(this.ruleForm.adjustPostWages);
        }
        return base + post;
      },
      computeChangeSize() {
    ...
    methods: {
      async saveData() {
        ...
        sendData.currentBasicSalary = sendData.adjustmentOfBasicWages
        sendData.currentPostWage = sendData.adjustPostWages
