            ...
            <el-table-column>
              <template slot-scope="scope">
                ...
                <div class="attentInfo" v-if="scope.row.dedTypeCode==='51000'">
                  ...
                  <p>
                    迟到>
                    <el-input v-model="scope.row.periodLowerLimit" class="inputInfo" disabled></el-input>
                    分钟
                  </p>
                  <div class="deductionInfo">
                    <p>
                ...
                <div class="attentInfo" v-if="scope.row.dedTypeCode==='52000'">
                  ...
                  <div class="deductionInfo">
                    ...
                    <p>
                      早退>
                      <el-input v-model="scope.row.timesLowerLimit" class="inputInfo" disabled></el-input>
                      次，每次扣款
                      <el-input
                        v-model="scope.row.dedAmonutLowerLimit"
                        class="inputInfo"
          ...
          >
            ...
            <el-form-item label prop="unit">
              <div class="ruleInfo">
                <p>
                  请假最小单位
                  <el-input v-model="overtimeBase.unit" style="width:50px"></el-input>
                  天
                </p>
              </div>
            </el-form-item>
...
<script>
  import {add} from '@/api/base/employees'
