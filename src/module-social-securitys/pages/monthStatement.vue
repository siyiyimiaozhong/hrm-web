    ...
    <div class="monthStatementTable">
      <div class="itemDropDown">
        ...
        >
          ...
          <el-table-column prop="timeOfEntry" label="入职时间" :formatter="transDateFormat" width="150px"></el-table-column>
...
<script>
  ...
  import {getArchivingArchive, getArchivingCont, newReport} from '@/api/hrm/socialSecuritys'
